    ...
    dashboardContent.innerHTML = `
        ...
        <div class="quick-actions">
            ...
            <div class="grid grid-3">
                ...
                <div class="action-card card" onclick="window.dispatchEvent(new CustomEvent('navigate', { detail: 'membership' }))">
                    <div class="action-icon">🎫</div>
                    <h3>Membership Details</h3>
                    <p>View your membership information</p>
                </div>

                <div class="action-card card" onclick="window.dispatchEvent(new CustomEvent('navigate', { detail: 'payments' }))">
                    <div class="action-icon">💳</div>
                    <h3>Payments</h3>
                    <p>Manage your payments and fees</p>
                </div>
